...
latex_documents = [
  (
      'index', 'main.tex',
      u'\\nmadb-utils Documentation', u'\\Vytautas Astrauskas', 'manual'
      ),
  ]
...
man_pages = [
    (
        'index', 'main',
        u'nmadb-utils Documentation', [u'Vytautas Astrauskas'], 1,
        ),
    ]
...
pdf_documents = [
    (
        'index', u'main',
        u'nmadb-utils Documentation', u'Vytautas Astrauskas'
        ),
    ]
